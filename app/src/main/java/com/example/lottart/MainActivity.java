...
public class MainActivity extends AppCompatActivity
    ...
    private ChatFragment requestsFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            requestsFragment = new ChatFragment();
            ...
            mainNav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (id) {
                        //Do some thing here
                        case R.id.lottery:
                            startActivity(new Intent(getApplicationContext(),Loterry_list.class));
                            return true;
                        ...
                        case R.id.withdraw:
                            ...
                            return true;
                        case R.id.coin:
                            startActivity(new Intent(getApplicationContext(),Coin2.class));
                            return true;
                        case R.id.gift:
                            startActivity(new Intent(getApplicationContext(),Coin_Transfer.class));
                            return true;
